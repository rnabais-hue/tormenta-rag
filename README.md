...
sobrescrever silenciosamente o chunk do núcleo. Índice atual (3995 chunks): `nucleo` 1498 +
...
`atlas-arton` 68 (Origens Regionais) + `deuses-arton` 325 (Cap 1 COMPLETO: classes 44 + resto 217 + menores 64). **Os 5 livros estão no índice.**
